...
import { Plus, Search, Smartphone, MoreHorizontal, Eye, Edit2, Copy, Trash2 } from 'lucide-react'
...
export default function CampaignWhatsAppPage() {
    ...
    <DashboardLayout workspace="campaign">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <StatCard title="Total Campaigns" value={whatsappCampaigns.length} icon={Smartphone} iconColor="text-purple-600" />
          <StatCard title="Total Sent" value={totalSent.toLocaleString()} icon={Smartphone} iconColor="text-blue-600" />
          <StatCard title="Delivered" value={totalDelivered.toLocaleString()} icon={Smartphone} iconColor="text-emerald-600" />
          <StatCard title="Read" value={totalOpened.toLocaleString()} icon={Smartphone} iconColor="text-orange-600" />
        </div>
