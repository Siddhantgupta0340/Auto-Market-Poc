...
import { Plus, Search, MessageSquare, MoreHorizontal, Eye, Edit2, Copy, Trash2 } from 'lucide-react'
    ...
    <DashboardLayout workspace="campaign">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <StatCard title="Total Campaigns" value={smsCampaigns.length} icon={MessageSquare} iconColor="text-blue-600" />
          <StatCard title="Total Sent" value={totalSent.toLocaleString()} icon={MessageSquare} iconColor="text-emerald-600" />
          <StatCard title="Delivered" value={totalDelivered.toLocaleString()} icon={MessageSquare} iconColor="text-purple-600" />
          <StatCard title="Clicks" value={totalClicked.toLocaleString()} icon={MessageSquare} iconColor="text-orange-600" />
        </div>
