...
import { Plus, Search, Mail, MoreHorizontal, Play, Pause, Eye, Edit2, Copy, Trash2 } from 'lucide-react'
    ...
    <DashboardLayout workspace="campaign">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          <StatCard title="Total Campaigns" value={emailCampaigns.length} icon={Mail} iconColor="text-emerald-600" />
          <StatCard title="Total Sent" value={totalSent.toLocaleString()} icon={Mail} iconColor="text-blue-600" />
          <StatCard title="Total Opens" value={totalOpened.toLocaleString()} icon={Eye} iconColor="text-purple-600" />
          <StatCard title="Total Clicks" value={totalClicked.toLocaleString()} icon={Mail} iconColor="text-orange-600" />
        </div>
